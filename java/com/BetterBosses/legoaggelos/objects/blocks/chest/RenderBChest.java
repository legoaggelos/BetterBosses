...
public class RenderBChest extends TileEntitySpecialRenderer<TileEntityBChest>
{
	private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MOD_ID + ":textures/blocks/birch_chest.png");
	private final ModelBChest MODEL = new ModelBChest();
