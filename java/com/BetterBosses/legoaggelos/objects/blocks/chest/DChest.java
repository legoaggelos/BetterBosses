...
public class DChest extends BlockContainer  
	
	{
		public static final PropertyDirection FACING = PropertyDirection.create("facing");
		public DChest(String name, Material material) 
		{
			super(material);
		...
		{
			playerIn.openGui(BetterBosses.instance, Reference.GUI_DCHEST, worldIn, pos.getX(), pos.getY(), pos.getZ());
			return true;
		}
		...
		{
			TileEntityDChest tileentity = (TileEntityDChest)worldIn.getTileEntity(pos);
