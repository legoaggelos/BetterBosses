...
public class SChest extends BlockContainer  
	
	{
		public static final PropertyDirection FACING = PropertyDirection.create("facing");
		public SChest(String name, Material material) 
		{
			super(material);
		...
		{
			return new TileEntitySChest();
		}
		
		@Override
		public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
		{
			playerIn.openGui(BetterBosses.instance, Reference.GUI_SCHEST, worldIn, pos.getX(), pos.getY(), pos.getZ());
			return true;
		}
		...
		{
			TileEntitySChest tileentity = (TileEntitySChest)worldIn.getTileEntity(pos);
		...
		public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) 
		{
			if(stack.hasDisplayName())
			{
				...
				if(tileentity instanceof TileEntitySChest)
				{
					((TileEntitySChest)tileentity).setCustomName(stack.getDisplayName());
				}
			}
		}
