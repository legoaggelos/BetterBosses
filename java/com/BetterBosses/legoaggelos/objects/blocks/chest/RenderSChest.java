...
{
	private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MOD_ID + ":textures/blocks/spruce_chest.png");
	private final ModelSChest MODEL = new ModelSChest();
	
	@Override
	public void render(TileEntitySChest te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) 
	{
		GlStateManager.enableDepth();
        GlStateManager.depthFunc(515);
        GlStateManager.depthMask(true);
    	
    	ModelSChest model = MODEL;
