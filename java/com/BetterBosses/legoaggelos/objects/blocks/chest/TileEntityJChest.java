...
public class TileEntityJChest extends TileEntityLockableLoot implements ITickable 
{
	...
	{
		return this.hasCustomName() ? this.customName : "Jungle Chest";
	}
	...
	{
		return new ContainerJChest(playerInventory, this, playerIn);
	}

	@Override
	public String getGuiID() 
	{
		return com.BetterBosses.legoaggelos.util.Reference.MOD_ID + ":birch_chest";
	}
	...
	public void update() 
	{
		if (!this.world.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + pos.getX() + pos.getY() + pos.getZ()) % 200 == 0)
        {
            ...
            {
                if (entityplayer.openContainer instanceof ContainerJChest)
                {
                    if (((ContainerJChest)entityplayer.openContainer).getChestInventory() == this)
                    {
