...
public class JChest extends BlockContainer  
	
	{
		public static final PropertyDirection FACING = PropertyDirection.create("facing");
		public JChest(String name, Material material) 
		{
			super(material);
		...
		{
			return new TileEntityJChest();
		}
		
		@Override
		public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
		{
			playerIn.openGui(BetterBosses.instance, Reference.GUI_JCHEST, worldIn, pos.getX(), pos.getY(), pos.getZ());
			return true;
		}
		...
		{
			TileEntityJChest tileentity = (TileEntityJChest)worldIn.getTileEntity(pos);
		...
		public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) 
		{
			if(stack.hasDisplayName())
			{
				...
				if(tileentity instanceof TileEntityJChest)
				{
					((TileEntityJChest)tileentity).setCustomName(stack.getDisplayName());
				}
			}
		}
