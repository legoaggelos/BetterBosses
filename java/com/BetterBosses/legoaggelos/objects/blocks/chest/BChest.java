...
public class BChest extends BlockContainer  
	
	{
		public static final PropertyDirection FACING = PropertyDirection.create("facing");
		public BChest(String name, Material material) 
		{
			super(material);
		...
		{
			playerIn.openGui(BetterBosses.instance, Reference.GUI_BCHEST, worldIn, pos.getX(), pos.getY(), pos.getZ());
			return true;
		}
		...
		{
			TileEntityBChest tileentity = (TileEntityBChest)worldIn.getTileEntity(pos);
		...
		public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) 
		{
			if(stack.hasDisplayName())
			{
				...
				if(tileentity instanceof TileEntityBChest)
				{
					((TileEntityBChest)tileentity).setCustomName(stack.getDisplayName());
				}
			}
		}
