...
public class AChest extends BlockContainer  
	
	{
		public static final PropertyDirection FACING = PropertyDirection.create("facing");
		public AChest(String name, Material material) 
		{
			super(material);
		...
		{
			return new TileEntityAChest();
		}
		
		@Override
		public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
		{
			playerIn.openGui(BetterBosses.instance, Reference.GUI_ACHEST, worldIn, pos.getX(), pos.getY(), pos.getZ());
			return true;
		}
		...
		{
			TileEntityAChest tileentity = (TileEntityAChest)worldIn.getTileEntity(pos);
		...
		public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) 
		{
			if(stack.hasDisplayName())
			{
				...
				if(tileentity instanceof TileEntityAChest)
				{
					((TileEntityAChest)tileentity).setCustomName(stack.getDisplayName());
				}
			}
		}
