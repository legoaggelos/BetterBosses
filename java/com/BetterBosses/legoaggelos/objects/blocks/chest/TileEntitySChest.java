...
public class TileEntitySChest extends TileEntityLockableLoot implements ITickable 
{
	...
	{
		return this.hasCustomName() ? this.customName : "Spruce Chest";
	}
	...
	{
		return new ContainerSChest(playerInventory, this, playerIn);
	}

	@Override
	public String getGuiID() 
	{
		return com.BetterBosses.legoaggelos.util.Reference.MOD_ID + ":spruce_chest";
	}
	...
	public void update() 
	{
		if (!this.world.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + pos.getX() + pos.getY() + pos.getZ()) % 200 == 0)
        {
            ...
            {
                if (entityplayer.openContainer instanceof ContainerSChest)
                {
                    if (((ContainerSChest)entityplayer.openContainer).getChestInventory() == this)
                    {
