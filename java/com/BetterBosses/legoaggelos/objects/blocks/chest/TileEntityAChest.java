...
public class TileEntityAChest extends TileEntityLockableLoot implements ITickable 
{
	...
	{
		return this.hasCustomName() ? this.customName : "Acacia Chest";
	}
	...
	{
		return new ContainerAChest(playerInventory, this, playerIn);
	}

	@Override
	public String getGuiID() 
	{
		return com.BetterBosses.legoaggelos.util.Reference.MOD_ID + ":acacia_chest";
	}
	...
	public void update() 
	{
		if (!this.world.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + pos.getX() + pos.getY() + pos.getZ()) % 200 == 0)
        {
            ...
            {
                if (entityplayer.openContainer instanceof ContainerAChest)
                {
                    if (((ContainerAChest)entityplayer.openContainer).getChestInventory() == this)
                    {
