...
public class TileEntityDChest extends TileEntityLockableLoot implements ITickable 
{
	...
	{
		return this.hasCustomName() ? this.customName : "Dark Oak Chest";
	}
	...
	{
		return new ContainerDChest(playerInventory, this, playerIn);
	}

	@Override
	public String getGuiID() 
	{
		return com.BetterBosses.legoaggelos.util.Reference.MOD_ID + ":doak_chest";
	}
	...
	public void update() 
	{
		if (!this.world.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + pos.getX() + pos.getY() + pos.getZ()) % 200 == 0)
        {
            ...
            {
                if (entityplayer.openContainer instanceof ContainerDChest)
                {
                    if (((ContainerDChest)entityplayer.openContainer).getChestInventory() == this)
                    {
