...
public class HelmetTungsten extends ItemArmor implements IHasModel
{


public HelmetTungsten(String name, ArmorMaterial material, int renderIndex, EntityEquipmentSlot equipmentSlot) {
